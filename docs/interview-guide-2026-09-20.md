...
阅读提示（2026-09-22）：本文保留 2026-09-20 的导读与验证快照。最新按专题组织的 116 道问答、个人记忆与错误处理更新、代码索引和本次复验结果见 [面试资料总入口](interview/README.md)；全部文档见 [文档导航](README.md)。本文历史测试数量与当时实现边界不自动代表当前工作树。
