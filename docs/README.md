...
进入 [面试资料总入口](interview/README.md)。它以当前工作树为依据，覆盖架构、上下文、压缩、个人记忆、错误处理、恢复、Plan、RAG、安全、评测及场景推演，每题配有回答和深入追问。

[2026-09-20 全项目导读](interview-guide-2026-09-20.md) 保留作为较早的系统 walkthrough；其中测试计数和实现状态请对照新入口，尤其是个人记忆和后续错误处理修复。
...
- `interview/`：面向口述和追问的派生材料；变更机制时同步相应题目和验证记录。
